...
csv_path = os.path.join(
    __file__, "..", "data", "Selfie_reduced", "processed", "selfie_dataset.csv"
)
projects = pd.read_csv(csv_path, sep=";")
...
df.expect_column_values_to_be_between(
    column="popularity_score", min_value=0, max_value=10
)
...
df.expect_column_values_to_be_in_set(
    column="wearing_sunglasses", value_set=binary_values
)
...
df.expect_column_values_to_be_in_set(
    column="showing_cellphone", value_set=binary_values
)
